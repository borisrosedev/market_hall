<template>
    ...
    <form class="col-12 col-xl-3 col-md-6 col-sm-8" @submit.prevent="onSubmit" @reset="onReset">
        ...
        <section class="my-3 d-flex flex-column" style="transition: height 300ms ease-in-out;">              
            <CustomMessage v-for="(message,i) in messages" :key="i" :obj="message" v-if="messages && messages.length > 0"  />
        </section>
    </form>
...
import { type CustomFormHandlersType, CustomFormInterface } from "../../interfaces/shared-interfaces/CustomFormInterface";
